...
# @pytest.fixture
# def supplier_product_repository(repository_factory) -> SupplierProductRepository:
...
# @pytest.fixture
# async def create_supplier_product_instance(
#     create_supplier_and_product,
# ) -> SupplierProductCreate:
#     """Fixture to create a SupplierProduct instance."""
#     supplier, product = await create_supplier_and_product
...
#     supplier_product = await supplier_product_repository.create(
#         create_supplier_product_instance
#     )
